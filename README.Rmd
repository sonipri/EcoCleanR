...
2.5. Flag the records associated wrong ocean/sea and inland
...
How to install package through zip file:<br>
 a) as mregion2 and rdigbio are not on cran, please             install them from github:<br>
      install.packages("remotes")<br>
      remotes::install_github("ropensci/mregions")<br>
      remotes::install_github("ropensci/ridigbio")<br>
 b) devtools::install_local("EcoCleanR-main.zip", dependencies = TRUE) #to install EcoCleanR package with dependent packages<br>
 c) Set the working directory on EcoCleanR-main unzip folder<br>
