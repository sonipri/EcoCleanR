...
list_outlier <- list()
list_outlier <- ec_flag_outlier(ecodata_unique, env_layers, itr = 100, k = 3, geo_quantile = 0.99, maha_quantile = 0.995)

ec_plot_distance(list_outlier[["result_list"]], geo_quantile = 0.99, maha_quantile = 0.995)
